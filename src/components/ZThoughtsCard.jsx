...
function ZThoughtsCard() {
  ...
  return (
    ...
    >
      ...
      <p style={{ color: '#666' }}>Pengen ngomel? Nangis? Ngaku dosa kecil? Tulis aja. Bebas, absurd, jujur — kayak hati lo. Gak ada nama, gak ada hakim, cuma lo & semesta digital.</p>
